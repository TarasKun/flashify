...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/icons/flashify-icon-192.png", sizes: "192x192", type: "image/png" },
      { url: "/icons/flashify-icon-512.png", sizes: "512x512", type: "image/png" },
    ],
...
#flashify-boot-splash span{display:block;width:64px;height:64px;border-radius:20px;background-image:url("/icons/flashify-icon-192.png");background-position:center;background-size:cover;box-shadow:0 16px 42px rgb(17 24 39 / 20%);}
...
@media (prefers-color-scheme:dark){html,body{background:#0d1020;}#flashify-boot-splash{background:#0d1020;color:#f8fbff;}#flashify-boot-splash p{color:#c8d1e3;}}
            `,
          }}
        />
